...
Mivel a hashtábla alap működési elve alapján az ütközések elég nagy adatmennyiség mellett teljesen elkerülhetetlenek, ezért ezeknek a kezelésére vödrös hash módszert alkalmazunk. Minden kulcson belül az értékek egy láncolt listában vannak eltárolva, az új elemek a lista végére kerülnek beszúrásra. Amikor kereséskor egy indexre érkezünk akkor a program lineárisan bejárja ezeket.
